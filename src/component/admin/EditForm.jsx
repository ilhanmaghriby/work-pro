...
const EditForm = () => {
  ...
  const { input, setInput, currentId, setCurrentId } = bagianState;
    ...
    <div className="formjob bg-[#BDCDD6]">
      ...
      <div className="p-4 job-vacancy sm:ml-64 ">
        <form onSubmit={handleSubmit}>
          <h1 className="text-3xl font-bold text-center">Edit Job Form</h1>
          <Input
            title="Title Job"
            change={handleInput}
            value={input.title}
          ...
          <input
            type="submit"
            className="p-2 mt-3 mb-10 font-bold text-white rounded-md bg-sky-700"
          />
        </form>
      </div>
    </div>
