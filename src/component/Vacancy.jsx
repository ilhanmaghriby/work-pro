...
const Vacancy = () => {
  ...
  return (
    <section className="bg-[#BDCDD6]">
      <Navbar />
      <section>
        <div className="text-3xl font-bold text-center pt-36">
        ...
        <div className="mt-6 text-center">
          <input
            ...
            className="w-full max-w-xs border-black input input-bordered"
            value={searchQuery}
          ...
          <input
            ...
            className="w-full max-w-xs mt-4 border-black input input-bordered"
            value={cityFilter}
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <Link to={`/vacancy/${item.id}`}>
                      <button className="btn bg-[#EEE9DA] rounded-lg">Here For More</button>
                    </Link>
                  </div>
                </div>
              ))}
